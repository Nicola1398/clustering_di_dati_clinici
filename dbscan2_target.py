...
plt.ylabel("eps")
plt.plot(distances)
plt.savefig("immagini/DBSCAN2_target/eps.pdf")
#plt.show()
plt.close()
...
plt.ylabel("eps")
plt.savefig("immagini/DBSCAN2_target/kneepoint.pdf")
#plt.show()
plt.close()
...
plt.tight_layout();
plt.savefig("immagini/DBSCAN2_target/heatmapDBSCAN.pdf")
#plt.show()
plt.close()
